CLASS zcl_data_file_upload_aag DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_data_file_upload_aag IMPLEMENTATION.
  METHOD if_http_service_extension~handle_request.
    ...
    CASE request->get_method( ).
      ...
      WHEN CONV string( if_web_http_client=>post ).
        ...
        DATA(ui_data) = request->get_form_field(
        `filetoupload-data` ).
...
| fileUploader.attachUploadCo mplete(function (oEvent) \{ \n| && | alert(oEvent.getParameters().response) \n| && | \}) \n| && | \n| && | \}) \n| && | \}) \n| && | \}) \n| && | \}) \n| && | </script> \n| && | </head> \n| && | <body class="sapUiBody"> \n|
&&
| <div id="uiArea"></div> "\n| && | </body> \n| && | \n| && | </html> |.
ENDMETHOD.
